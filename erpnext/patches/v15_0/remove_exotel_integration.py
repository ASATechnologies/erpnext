...
def notify_existing_users():
	click.secho(
		"Exotel integration is moved to a separate app and will be removed from ASAERP in version-15.\n"
	...
	notification = {
		"subject": _(
			"WARNING: Exotel app has been separated from ASAERP, please install the app to continue using Exotel integration."
		),
		"type": "Alert",
	}
